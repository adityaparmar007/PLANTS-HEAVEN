...
<!-- Logout Modal-->
    ...
    <!-- Navbar End -->
<div class="table-responsive"  style="position:absolute; left:400px; bottom:200px;">
     <div class="col-lg-9 col-md-2 col-sm-2 pb-1">
      ...
      <table class="table table-bordered" id="dataTable" width="90%" cellspacing="0">
        <thead>
         ...
         <tbody>
             <?php 
            $product_Emailid = $_SESSION["Emailid"];
            $query="SELECT * FROM order_product WHERE product_Emailid='$product_Emailid'";
            ...
            <?php
                ...
                <tr>
                    ...
                    <td>
                       <form action="cancelorder.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="order_product_id" value="<?php echo $row['order_product_id']?> ">
                            <button  type="submit" name="delete_btn" class="btn btn-success">CANCELORDER</button>
                        </form>
                    </td>
                </tr>
                <?php 
